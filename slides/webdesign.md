...
<ul>
	...
	<li class="c-text-md fragment">výstupem je (mj.) schéma/nárys = wireframe webu (, stránky, komponenty)</li>
</ul>
...
<ul>
	...
	<li class="c-text-md fragment">Výstupem je obrázek webové stránky.</li>
</ul>
...
<ul>
	...
	<li class="c-text-md fragment">Výstupem je webová stránka.</li>
